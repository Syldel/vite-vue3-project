...
<template>
  ...
  <footer class="footer">
    <div class="footer__line">
      <svg class="footer__logo" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <p>GitHub by <a href="https://github.com/Syldel" class="footer__link">@Syldel</a>. Using Vue v{{ vueVersion }}</p>
    </div>
  </footer>
</template>
